...
lyr__0.set('fieldAliases', {'PROVNO': 'PROVNO', 'KABKOTNO': 'KABKOTNO', 'KECNO': 'KECNO', 'DESANO': 'DESANO', 'PROVINSI': 'PROVINSI', 'KABKOT': 'KABKOT', 'KECAMATAN': 'KECAMATAN', 'DESA': 'DESA', 'IDDESA': 'IDDESA', 'TAHUN': 'TAHUN', 'SUMBER': 'SUMBER', '_mean': '_mean', '_median': '_median', '_min': '_min', '_max': '_max', 'wse': 'wse', 'Energi (W)': 'Energi (W)', });
lyr__0.set('fieldImages', {'PROVNO': 'TextEdit', 'KABKOTNO': 'TextEdit', 'KECNO': 'TextEdit', 'DESANO': 'TextEdit', 'PROVINSI': 'TextEdit', 'KABKOT': 'TextEdit', 'KECAMATAN': 'TextEdit', 'DESA': 'TextEdit', 'IDDESA': 'TextEdit', 'TAHUN': 'TextEdit', 'SUMBER': 'TextEdit', '_mean': 'TextEdit', '_median': 'TextEdit', '_min': 'TextEdit', '_max': 'TextEdit', 'wse': 'TextEdit', 'Energi (W)': 'Range', });
lyr__0.set('fieldLabels', {'PROVNO': 'hidden field', 'KABKOTNO': 'hidden field', 'KECNO': 'hidden field', 'DESANO': 'hidden field', 'PROVINSI': 'header label - always visible', 'KABKOT': 'header label - always visible', 'KECAMATAN': 'header label - always visible', 'DESA': 'hidden field', 'IDDESA': 'hidden field', 'TAHUN': 'hidden field', 'SUMBER': 'hidden field', '_mean': 'hidden field', '_median': 'hidden field', '_min': 'hidden field', '_max': 'hidden field', 'wse': 'hidden field', 'Energi (W)': 'header label - always visible', });
